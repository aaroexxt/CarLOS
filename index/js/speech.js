...
//^basically blabla without listener functionality and changed name
...
var Speech = (function () {
  ...
  Speech.setVoice = function (name) {
    ...
    if (!search.length) {
      throw Error('Not a valid voice \'' + name + '\', use Speech.listVoices to get the available voices');
    }
    _settings.voice = search[0];
  };

  Speech.speak = function (sentence) {
