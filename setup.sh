...
sudo npm install --prefix $cwd request browserify watchify async debug child-process brain.js window-size single-line-log serialport node-fetch finalhandler;
